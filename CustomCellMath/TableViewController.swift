...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.firstNumberLabel.text = "\(currentNumber[0])"
        cell.secondNumberLabel.text = "\(currentNumber[1])"
        cell.thirdNumberLabel.text = "\(currentNumber[2])"
        cell.fourthNumberLabel.text = "\(currentNumber[3])"
